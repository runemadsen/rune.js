...
describe("Rune.Render", function() {
  ...
  describe("Rune.Path", function() {
    ...
    it("should render path", function() {
      ...
      expect(jshape).toHaveAttr("d", "M 100 101 m 102 103 L 104 105 l 106 107 C 108 109 110 111 112 113 c 114 115 116 117 118 119 S 120 121 122 123 s 124 125 126 127 Q 128 129 130 131 q 132 133 134 135 T 136 137 t 138 139 Z")
      expect(jshape).toHaveTranslation(10, 15);
      expectShared(jshape);
    });
