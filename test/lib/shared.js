...
},{"jquery":1,"underscore":2}],4:[function(require,module,exports){
"use strict";
...
},{"../matchers":3,"./anchor":4,"./color":5,"./grid":6,"./group":7,"./mixins/moveable":10,"./mixins/sizeable":11,"./mixins/styleable":12,"./render":13,"./rune":14,"./shapes/circle":15,"./shapes/ellipse":16,"./shapes/line":17,"./shapes/path":18,"./shapes/polygon":19,"./shapes/rect":20,"./shapes/text":21,"./utils":22,"./vector":23}],10:[function(require,module,exports){
"use strict";
...
},{"../helpers":8,"underscore":2}],13:[function(require,module,exports){
"use strict";
...
describe("Rune.Render", function () {
  ...
  describe("All shapes", function () {
    ...
    it("should handle false vars", function () {
      var s = r.rect(0, 0, 0, 0).fill(false).stroke(false).strokeWidth(false).strokeCap(false).strokeJoin(false).strokeMiterlimit(false).strokeDash(false).strokeDashOffset(false);
      r.draw();
    ...
    it("renders rotation with 0", function () {
      var s = r.rect(0, 0, 0, 0).rotate(45, 0, 10);
      r.draw();
      var jshape = jel.children().first();
  ...
  describe("Rune.Path", function () {
    ...
    it("should render optional vars", function () {
      ...
      _underscore2["default"].each(optionals, function (v, k) {
        var s = r.path(10, 15);
        r.draw();
        expect((0, _jquery2["default"])(el).children().first().attr(v[0])).toBeUndefined();
        s[k](v[1]);
        r.draw();
        expect((0, _jquery2["default"])(el).children().first().attr(v[0])).toEqual(v[1] + "");
      });
    });
  });
...
},{"./helpers":8,"jquery":1,"underscore":2}],14:[function(require,module,exports){
"use strict";
...
},{"../helpers":8,"underscore":2}],19:[function(require,module,exports){
"use strict";
...
},{"../helpers":8}],20:[function(require,module,exports){
"use strict";
...
},{"../helpers":8}],21:[function(require,module,exports){
'use strict';
...
},{"../helpers":8,"underscore":2}],22:[function(require,module,exports){
"use strict";
